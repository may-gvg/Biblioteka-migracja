...
book_to_author = Table('book_to_author', db.metadata,
...
class Book(db.Model):
    ...
    authors = relationship("Author", secondary=book_to_author, back_populates="authors")
...
class Author(db.Model):
    ...
    books = relationship("Book", secondary=book_to_author, back_populates="books")
